...
public class Error {
  ...
  */
  ...
  @Schema(name = "type", example = "object", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  @JsonProperty("type")
  ...
  */
  ...
  @Schema(name = "title", example = "Validation failed", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  @JsonProperty("title")
